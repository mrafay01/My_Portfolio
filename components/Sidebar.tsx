    ...
    return (
        ...
        >
            ...
            <motion.div variants={itemVariants} className="space-y-6 flex flex-col items-center lg:items-start w-full">
                <div className="relative w-32 h-32 md:w-36 md:h-36 rounded-3xl overflow-hidden border-2 border-primary/20 p-2 backdrop-blur-sm group shadow-[0_0_30px_rgba(59,130,246,0.2)]">
